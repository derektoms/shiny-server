...
#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$#$
 ...
 gene_heatmap = function(eset, subset_probes, anno_col = 'tissue', probe_level = FALSE, gsm_show = TRUE, ...) {
   ...
   #mat = t(scale(t(mat)))
   rownames(mat) = paste(getSYMBOL(rownames(mat), "mouse4302.db"),rownames(mat),sep=":")
   ...
   pheatmap(mat, show_colnames = gsm_show, annotation_col = anno_df, annotation_colors = anno_colours, ...)
