...
navbarPage("receptoR",
    ...
    tabPanel("Start here",
        ...
        sidebarLayout(
            sidebarPanel(
                ...
                hr(),
                p("code created by Derek Toms, Qing Yun Tong and Matthew Workentine with funding from the Canadian National Institute for the Blind; ", tags$a(href="https://cnib.ca/","Click here to donate!",target="_blank")),
    ...
    tabPanel("Search Transcriptome Database",
        ...
        h3("Find publicly available expression data for your cell types of interest"),
        hr(),
        sidebarLayout(
            sidebarPanel(
    ...
    tabPanel("Load Expression Datasets",
        ...
        sidebarLayout(
            sidebarPanel(
                ...
                hr(),
                checkboxGroupInput("genelist", "Select a receptor type to analyze", choices = NULL),
                br(),
    ...
    tabPanel("Gene-level Expression",
        ...
        sidebarLayout(
            sidebarPanel(
                h4("Gene expression"),
                checkboxGroupInput("tissues", label = "Select tissues to include", choices = NULL, selected = NULL),
                br(),
            ...
            mainPanel(
                tabsetPanel(type = "tabs", id = "absexpanel",
    ...
    tabPanel("Sample-level Expression",
        ...
        sidebarLayout(
            sidebarPanel(
                ...
                checkboxGroupInput("pls_tissues", label = "Select tissues to inclued", choices = NULL, selected = NULL),
            ...
            mainPanel(
                position = c("right","left"), fluid = TRUE,
